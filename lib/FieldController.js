...
exports.newFieldState = newFieldState;
class FieldController {
     ...
     */
    useForm = () => {
        [this.state, this.setState] = (0, react_1.useState)(this.defaultState);
    };
    /**
