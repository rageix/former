...
class Former {
    ...
    constructor(settings) {
        ...
        for (const [key, value] of Object.entries(settings.defaultValues)) {
            fields[key] = new FieldController_1.default(value, this);
        }
        this.fields = fields;
    }
    /**
    ...
    useForm = (onSubmitFn) => {
        ...
        [this.valid, this.setValid] = (0, react_1.useState)(true);
        [this.submitted, this.setSubmitted] = (0, react_1.useState)(false);
        return this;
    };
    /**
